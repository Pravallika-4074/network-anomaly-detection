...
model_url = "https://drive.google.com/uc?id=1vQ5MbtdNElMQC8fxTdlFAnBBXdsW49NK"
scaler_url = "https://drive.google.com/uc?id=179tYueY_YU1eFvuwb-qAQtNXVOYIfYdB"
...
if __name__ == '__main__':
    port = int(os.environ.get('PORT', 10000))  # use 10000 by default if PORT env variable not set
